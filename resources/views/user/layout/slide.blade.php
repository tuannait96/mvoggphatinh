  <div class="main-banner header-text">
      <div class="container-fluid">
        <div class="owl-banner owl-carousel">
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-01.jpg')}}" alt="">
          ...
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-02.jpg')}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Nature</span>
          ...
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-03.jpg')}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Lifestyle</span>
          ...
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-04.jpg')}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Fashion</span>
          ...
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-05.jpg')}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Nature</span>
          ...
          <div class="item">
            <img src="{{asset('user_asset/assets/images/banner-item-06.jpg')}}" alt="">
            <div class="item-content">
              <div class="main-content">
                <div class="meta-category">
                  <span>Lifestyle</span>
